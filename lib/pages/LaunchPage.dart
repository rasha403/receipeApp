...
class LaunchCategoryPage extends StatefulWidget {
  final String category;
  final String title;

  const LaunchCategoryPage({
    Key? key,
  ...
  @override
  State<LaunchCategoryPage> createState() => _LaunchCategoryPageState();
}

class _LaunchCategoryPageState extends State<LaunchCategoryPage> {
  ...
  Future<void> _loadRecipes() async {
    ...
    try {
      ...
      // Debug: Check for launch recipes specifically
      List<Map<String, dynamic>> launchRecipes = await _dbHelper.getRecipesByCuisineType('Launch');
      print('Launch recipes found: ${launchRecipes.length}');
  ...
  Future<void> _showAddRecipeDialog() async {
    ...
    await showDialog(
      ...
      builder: (context) => AlertDialog(
        title: const Text('Add New Launch Recipe'),

...
class SnacksCategoryPage extends StatefulWidget {
  final String category;
  final String title;

  const SnacksCategoryPage({
    Key? key,
  ...
  @override
  State<SnacksCategoryPage> createState() => _SnacksCategoryPageState();
}

class _SnacksCategoryPageState extends State<SnacksCategoryPage> {
  ...
  Future<void> _loadRecipes() async {
    ...
    try {
      ...
      // Debug: Check for snack recipes specifically
      List<Map<String, dynamic>> snackRecipes = await _dbHelper.getRecipesByCuisineType('Snacks');
      print('Snack recipes found: ${snackRecipes.length}');
  ...
  Future<void> _showAddRecipeDialog() async {
    ...
    await showDialog(
      ...
      builder: (context) => AlertDialog(
        title: const Text('Add New Snack Recipe'),
